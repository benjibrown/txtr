...
- **Compilation.** Compile your document without even leaving the editor. Baked-in support for `pdflatex`, `xelatex`, `lualatex`, `latexmk` and `tectonic`. Custom compilation commands also supported. Parse errors and jump straight to the offending line.
